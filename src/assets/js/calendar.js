      ...
      _initselected: function () {
        ...
        */
        ...
        if (me.sourceData && me.sourceData.length !== 0) {
          /*if (me.sourceData[0].status !== 'BOOKED' || me.sourceData[0].status !== 'CHECKED_IN') {
            $arryeven.eq(0).text('今天');
            $arryeven.eq(0).attr('data-txt', '今天');
          }*/
          for (var i = 0; i < $arryodd.length; i++) {
            ...
            if (me.sourceData[i].status === 'BOOKED' || me.sourceData[i].status === 'CHECKED_IN') {
      ...
      _selectDate: function (arry1) {
        ...
        $(arry1).on('click', function (index) {
          ...
          if (flag == 0) {
            ...
            if (me.sourceData && me.sourceData !== '') {
              //计算总共多少天totalDay
              totalDays = Math.abs(second - first);
              if (totalDays == 0) {
                totalDays = 1;
              }
            }
            ...
            //     if ($(this).text() == '退房') {
            //         $(this).parent('td').append('<span class="hover">' + totalDays + '天</span>')
